...
from Common.path_config import screenshot_path
...
handler_2 = RotatingFileHandler(logs_path+"/SP_APPUItest_{0}.log".format(curTime),backupCount=20,encoding='utf-8')
